      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '500px' }}>
          ...
          <h1 style={{ fontSize: '3.5rem', fontWeight: '800', lineHeight: 1.1, marginBottom: '20px' }}>
            Welcome back to SHNOOR.
          </h1>
          <p style={{ fontSize: '1.2rem', color: '#94a3b8', lineHeight: 1.6 }}>
            Sign in to manage your e-commerce orders, review purchase requests, and continue exploring our premium services.
          </p>
        </div>
        {/* Decorative elements */}
      ...
      <div style={{
        ...
        >
          <div style={{ marginBottom: '40px' }}>
            <h2 style={{ fontSize: '2.2rem', fontWeight: '800', color: '#0f172a', marginBottom: '10px' }}>Sign In</h2>
            <p style={{ color: '#64748b', fontSize: '1.1rem' }}>Enter your credentials to access your account.</p>
          </div>

          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div>
              <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: '#475569', fontSize: '0.95rem' }}>Username / Email</label>
